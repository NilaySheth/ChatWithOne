...
import com.example.nilays.chatwithone.ui.adapter.DialogsAdapter;
...
import com.example.nilays.chatwithone.utils.qb.QbDialogHolder;
...
//    }
    ...
    public void onSessionCreated(boolean success) {
        if (success) {
            ...
            ChatHelper.getInstance().createDialogWithSelectedUsers(temp, new QBEntityCallback<QBDialog>() {
                @Override
    ...
    private void loadDialogsFromQb(final boolean silentUpdate, final boolean clearDialogHolder) {
        if (!silentUpdate) {
            ...
            @Override
                ...
                ChatActivity.startForResult(DialogsActivity.this, REQUEST_MARK_READ, dialogs.get(0));
